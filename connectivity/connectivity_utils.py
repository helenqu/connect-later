...
sys.path.insert(1, os.path.join(sys.path[0], '../targeted_augs'))
import wilds
...
def get_astro_dataset():
    test = load_dataset("/pscratch/sd/h/helenqu/plasticc/raw_test_with_labels", cache_dir=CACHE_DIR)['train']
    train_dataset = load_dataset("/pscratch/sd/h/helenqu/plasticc/raw_train_with_labels", cache_dir=CACHE_DIR)
...
def get_wilds_dataset(dataset_name):
    return wilds.get_dataset(
        ...
        root_dir=f"/pscratch/sd/h/helenqu/targeted_augs/{dataset_name}",
    )
